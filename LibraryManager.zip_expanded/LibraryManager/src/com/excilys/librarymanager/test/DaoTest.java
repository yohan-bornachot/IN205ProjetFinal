...
public class DaoTest {
	...
	public static void main(String[] args) throws Exception{
		...
		// ---------- Test implÃ©mentation dao livre ----------
		
		LivreDao livre = LivreDaoImpl.getInstance();
		List<Livre> livreList;
		
		try {
			printHeader("# # # # # # # # Tests d'implÃ©mentation de la dao pour les livres # # # # # # # #");
			...
			printHeader("Mise à  jour d'un livre");
		...
		// ---------- Test implÃ©mentation dao membre ----------
		...
		try {
			...
			printHeader("Mise à  jour d'un membre");
		...
		// ---------- Test implÃ©mentation dao emprunt ----------
		...
		try {
			...
			printHeader("Mise à  jour d'un emprunt");
