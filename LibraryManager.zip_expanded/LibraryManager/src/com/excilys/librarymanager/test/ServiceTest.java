...
public class ServiceTest {
	...
	public static void main(String[] Args) throws Exception{
		...
		// ---------- Test implémentation service livre ----------
		...
		try {
			...
			DaoTest.printHeader("Récupération d'un livre par son identifiant");
			Livre newLivre = livre.getById(idNewLivre);
			System.out.println(newLivre);
			
			DaoTest.printHeader("Mise à  jour d'un livre");
			...
			for (int i=0; i<livreList.size();i++) 
 			...
 			System.out.println("\nNB : 7 livres sont disponibles.\nDans la BD initiale qui possède 10 livres,\n" + 
						"3 livres n'ont pas encore été rendus. Ca paraît cohérent.");
