  ...
  <main>
    <section class="content">
      ...
      <h5>Suppression du membre n${!empty livre ? livre.id : ''}}</h5> <!-- TODO : afficher l'id du livre au lieu de 42 -->
        <div class="row">
          <p>Etes-vous sûr de vouloir supprimer le livre "${!empty livre ? livre.titre : 'TitreDuLivre'}" de ${!empty livre ? livre.auteur : 'NomDeLAuteur'} (${!empty livre ? livre.isbn : 'code isbnDuLivre'}) ?</p> <!-- TODO : compl�ter les trois informations ci-contre -->
