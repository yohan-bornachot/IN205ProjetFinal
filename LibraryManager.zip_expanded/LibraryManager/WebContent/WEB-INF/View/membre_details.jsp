...
<body>
  ...
  <main>
    <section class="content">
      ...
      <div class="row">
      <div class="container">
      <h5>D�tails du membre n${!empty membre ? membre.id : ''}</h5> <!-- TODO : remplacer 007 par l'id du membre -->
        <div class="row">
	      <form action="/LibraryManager/membre_details?id=${membre.id}" method="post" class="col s12"> <!-- TODO : remplacer idDuMembre par l'id du membre -->
	        <div class="row">
	          <div class="input-field col s4">
	            <input id="nom" type="text" value="${!empty membre ? membre.nom : ''}" name="nom"> <!-- TODO : remplacer nomDuMembre par le nom du membre -->
	            <label for="nom">Nom</label>
	          </div>
	          <div class="input-field col s4">
	            <input id="prenom" type="text" value="${!empty membre ? membre.prenom : ''}" name="prenom"> <!-- TODO : remplacer prenomDuMembre par le pr�nom du membre -->
	        ...
	        <div class="row">
	          <div class="input-field col s12">
	            <input id="adresse" type="text" value="${!empty membre ? membre.adresse : ''}" name="adresse"> <!-- TODO : remplacer adresseDuMembre par l'adresse du membre -->
	            <label for="adresse">Adresse</label>
	          </div>
	        </div>
	        <div class="row">
	          <div class="input-field col s6">
	            <input id="email" type="email" value="${!empty membre ? membre.email : ''}" name="email"> <!-- TODO : remplacer emailDuMembre par l'email du membre -->
	            <label for="email">E-mail</label>
	          </div>
	          <div class="input-field col s6">
	            <input id="telephone" type="tel" value="${!empty membre ? membre.telephone : ''}" name="telephone"> <!-- TODO : remplacer telephoneDuMembre par le t�l�phone du membre -->
